	...
	<main class="">
		<section class="container-fluid">
			<div class="mt-5 d-flex">
				<div class="mr-5 d-flex flex-row">
					<h2 class="fuente2 text-center p-2">PRECIOANA PARA REGISTARAR TU MASCOTA &nbsp; <i class="fas fa-arrow-right "></i></h2>
				</div>
					...
					<div class="">
						...
						<form class="mb-3" action="<?= site_url('/animales/registro/nuevo') ?>" method="POST">
							...
							<div class="d-grid gap-2">
								<button class="btn boton fondo text-white fuente2" type="submit">Registrar Mascota</button>
							</div>
		...
		<section class="container">
			<div class="col-12 col-md-5 align-self-end text-center mt-5">
				<img src="<?= base_url('public/img/perros.png') ?>" alt="imagen" class="img-fluid w-100">
